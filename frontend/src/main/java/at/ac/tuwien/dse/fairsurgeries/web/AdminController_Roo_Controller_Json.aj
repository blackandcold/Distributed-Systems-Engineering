...
privileged aspect AdminController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> AdminController.showJson(@PathVariable("id") BigInteger id) {
    ...
    public ResponseEntity<String> AdminController.deleteFromJson(@PathVariable("id") BigInteger id) {
        Admin admin = adminService.findAdmin(id);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (admin == null) {
