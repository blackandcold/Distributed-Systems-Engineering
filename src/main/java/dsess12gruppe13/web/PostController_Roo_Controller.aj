...
import dsess12gruppe13.web.PostController;
...
privileged aspect PostController_Roo_Controller {
    ...
    public String PostController.show(@PathVariable("id") BigInteger id, Model uiModel) {
    ...
    public String PostController.updateForm(@PathVariable("id") BigInteger id, Model uiModel) {
        populateEditForm(uiModel, postService.findPost(id));
        return "posts/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String PostController.delete(@PathVariable("id") BigInteger id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
